...
public interface StatsDClient {
	...
	/**
	 * Adjusts the specified counter by a given delta and sample rate.
	 * 
	 * @param aspect
	 *            the name of the counter to adjust
	 * @param delta
	 ...
	 *            the sample percentage rage from 1-100
	 */
	void count(String aspect, int delta, int samplePercentage);
	...
	/**
	 * Increment the specified counter by one using the given sample rate.
	 * 
	 * @param aspect
	 *            the name of the counter to increment
	 * @param samplePercentage
	 *            the sample percentage from 1-100
	 */
	void increment(String aspect, int samplePercentage);
